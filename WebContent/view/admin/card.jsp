			      ...
			      cardList: [
			        {
			          ...
			          cardExt: '{"code": "", "openid": "", "timestamp":"'+'${cardConfig["timestamp"]}' +'", "signature":"'+'${cardConfig["signature"]}'+'"}'
			        }
			      ],
			      success: function (res) {
			        alert('已添加优惠卷到卡包：');// + JSON.stringify(res.cardList)
			        wx.closeWindow();
			      },
			      cancel: function (res) {
...
<!-- <button id ="ss">领啊煞风景啊螺丝钉解放山东的</button> -->
 	<div class="am-modal am-modal-loading am-modal-no-btn" tabindex="-1"
		...
		<div class="am-modal-dialog">
			<div class="am-modal-hd">领优惠卷的的途中...</div>
